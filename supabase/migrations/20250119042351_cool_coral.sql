...
DO $$ BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'withdrawal_settings') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'payout_schedules') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'payout_history') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'admin_commission_settings') THEN
